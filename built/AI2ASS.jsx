...
win.clip = win.add("Group {orientation: 'row', noclip: RadioButton { text: 'drawing', value: true }, clip: RadioButton { text: 'clip' }, iclip: RadioButton { text: 'iclip' }, bare: RadioButton { text: 'bare' }, line: RadioButton { text: 'line' } }");
